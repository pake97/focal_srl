 ...
 */
 ...
 App.evolve = function() {
   ...
   // DISCOMMENT THIS TO CHANGE COLOR!!
   //this.stepCount++;
 ...
 $(document).ready(function() {
    ...
    var shadowMaxDistance = 30; // in pixels
    var shadowSpread = '5px';
    var shadowColor = 'rgba(97, 181, 255, 1)';
    
    var pageWidth = $w.outerWidth();
    var pageHeight = $w.outerHeight();
    
    var moveShadow = function(e) {
      
      // todo: calculate shadow offset based on mouse position relative to element rather than page 
  
      var aX = e.pageX - (pageWidth / 2);
      var aY = e.pageY - (pageHeight / 2);
  
      var ratioX = aX / pageWidth;
      var ratioY = aY / pageHeight;
  
      var shadowX = ratioX * shadowMaxDistance * -1; 
      var shadowY = ratioY * shadowMaxDistance * -1; 
  
      var shadowCSS = shadowX + 'px ' + shadowY + 'px ' + shadowSpread + ' ' + shadowColor;
  
      $shadowed.css({
        'text-shadow': shadowCSS,
        '-webkit-text-shadow': shadowCSS,
        '-moz-text-shadow': shadowCSS
      });
    };
    
    var moveGlow = function(e) {
